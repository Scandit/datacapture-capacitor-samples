...
Get started with LabelCapture on [iOS](https://docs.scandit.com/sdks/ios/label-capture/get-started/), [Android](https://docs.scandit.com/sdks/android/label-capture/get-started), [Capacitor](https://docs.scandit.com/sdks/capacitor/label-capture/get-started/).
